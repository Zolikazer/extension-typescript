...
//
//     listenToMessages = () => {
//         this.chromeApi.onMessage((request) => {
//                 switch (request.msg) {
//                     case BEEP:
//                         beep();
//                         break;
...
//             title: "Report NTA",
//             message: "Do not forget to report NTA!",
//             type: "basic",
...
//     const resetTimer = new TimerReset(arrowexTimer);
//     const background = new Background(arrowexTimer, resetTimer);
//     arrowexTimer.addEventListener(ArrowexTimer.INIT, background.run);
//
//     arrowexTimer.init();
//     console.log("it run!")
// }
